...
def process_menu_tree_data(request):
    ...
    {'permission__url': '/report.html', 'permission_id': 3, 'permission__caption': '报表管理', 'permission__menu_id': 1}, 
    {'permission__url': '/trouble.html', 'permission_id': 1, 'permission__caption': '报障', 'permission__menu_id': 1}
    ]
    """
...
def rbac_css():
    '''
    根据配置文件中的RBAC_THEME参数读取相对应的CSS文件
