...
class ProjectList(models.Model):
    ...
    class_type = models.SmallIntegerField(choices=type_choice, default=0, verbose_name='工程类型')
    status_choice = ((0, '未完成'), (1, '完成'), (2, '在建'))
    status_type = models.SmallIntegerField(choices=status_choice, default=0, verbose_name='工程状态')
    duration = models.IntegerField('工期/天')
