...
class PageInfo(object):
    ...
    def pager(self):
        ...
        if self.current_page == 1:
            ...
            pre = "<li><a href='{}?{}' class='pre-page'>上一页</a></li>".format(self.path_info, self.param_dict.urlencode())
        else:
        ...
        for _ in range(start, stop):
            ...
            if self.current_page == _:
                tpl = "<li><a href='{}?{}' class='page-active'>{}</a></li>".format(self.path_info, self.param_dict.urlencode(), _)
            else:
                tpl = "<li><a href='{}?{}' >{}</a></li>".format(self.path_info, self.param_dict.urlencode(), _)
            show_list.append(tpl)

        # 下一页
        if self.current_page == self.all_page:
            self.param_dict['page'] = self.all_page
            pre = "<li><a href='{}?{}' class='next-page'>下一页</a></li>".format(self.path_info, self.param_dict.urlencode())
        else:
            self.param_dict['page'] = self.current_page + 1
            pre = "<li><a href='{}?{}' class='next-page'>下一页</a></li>".format(self.path_info, self.param_dict.urlencode())
        show_list.append(pre)
