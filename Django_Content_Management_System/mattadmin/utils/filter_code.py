    ...
    def __iter__(self):
        ...
        for row in self.queryset:
            ...
            if self.option.is_multi:
                # 多选时 param_dict 需要增加，最后体现在url GET请求的参数位置
                # request.GET：{'page': ['2'], 'username': ['dqdw'], 'ewq': ['12'] 需要append进去
                ...
                if value in value_list:
                    ...
                    # print('value_list_mem_addr',id(value_list))
                    # print('param_mem_addr',id(param_dict.getlist(self.option.name)))
                    from django.http.request import QueryDict
